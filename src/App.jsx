...
// Cloud save — debounced, strips transient fields
...
// Cloud load — returns saved state or defaults
...
function PF({onSubmit,label="CADASTRAR",initial={},showRating=false}){
  ...
  return <div>
    <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"0 12px"}}>
      ...
      {fd("PIN de Acesso (4 dígitos)","pin","1234",{type:"password",maxLength:4,pattern:"[0-9]*",inputMode:"numeric"})}
...
export default function App(){
  ...
  if(!role)return <div style={{minHeight:"100vh",fontFamily:ff,color:K.tx,position:"relative"}}><GeoBg light={light}/><div style={{position:"relative",zIndex:1,maxWidth:920,margin:"0 auto",padding:"0 16px"}}><LoginScreen onRole={sRole} light={light} toggleTheme={toggleTheme} S={S} sLoggedPlayer={sLoggedPlayer}/></div></div>;
